...
const OrderCompletionItem = ({
  ...
  const form = useForm({
    ...
    defaultValues: {
      brandName: "",
      noBrand: true,
      quantity: item.receivedQuantity.toString() || "0",
      perQuantity: "0",
  ...
  return (
    <>
      ...
      >
        ...
        <TableCell className="px-3 font-medium text-sm">{index + 1}</TableCell>
        <TableCell className="px-3">
          <div className="flex items-center gap-2">
            <Package className="h-4 w-4 text-muted-foreground" />
            <div className="min-w-0">
              <p className="text-sm font-medium truncate">{item.supply.item}</p>
        ...
        <TableCell className="px-3 max-w-xs">
        ...
        <TableCell className="px-3 text-right">
          <div className="flex flex-col items-end">
            <span className="text-sm font-medium">{item.receivedQuantity}</span>
      ...
      <Modal
        title={
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold">{item.supply.item}</h3>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="1">OK - Accept Item</SelectItem>
                            <SelectItem value="2">
              ...
              <div className="space-y-4 border rounded-lg p-4">
                ...
                {!noBrand && (
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Custom Brand/Product Name</FormLabel>
                        <FormControl>
                          <Input
